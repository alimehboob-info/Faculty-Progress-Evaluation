        ...
        <div class="row">
            <div class="col-md-9 addteachermargin">
                ...
                <div class="card shadow bg-white ">
                    <h5 class="card-header addheadercolor">Add Student</h5>
                    <div class="card-body bg-white">
                        ...
                        <form action="student-insert.php" method="Post">
                            <div class="input-group flex-nowrap mb-3 shadow placeholderwidth">
                                ...
                                <input type="text" class="form-control" name="teachername" placeholder="Enter Student Name" required>
                            </div>
                            <div class="input-group flex-nowrap mb-3 shadow placeholderwidth">
                                <div class="input-group-prepend">
                                    <span class="input-group-text" id="addon-wrapping">Teacher Email</span>
                                </div>
                                <input type="email" class="form-control" name="teacheremail" placeholder="Enter Email" required>
                            </div>
                            <div class="input-group flex-nowrap mb-3 shadow placeholderwidth">
                                <div class="input-group-prepend">
                    ...
                    <h5 class="card-header addheadercolor ">Student Record</h5>
                    <div class="card-body bg-white">
                        <!-- php code to fetch record and show in table start -->
                        <?php
                        $query = "SELECT `id`, `name`, `email` FROM `student_login`";
                                ...
                                ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="delete">
                                                <form method="post" action="std_delete.php?id=<?php echo $row['id']; ?>">
