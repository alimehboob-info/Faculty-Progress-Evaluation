                    ...
                    <div class="card-body bg-white">
                        ...
                        <table class="table table-striped table-bordered table-font">
                            ...
                            <tbody>
                                ...
                                // Query to fetch distinct clo_id values for the subject "Visual Programming"
                                $cloQuery = "SELECT DISTINCT clo_id FROM student_feedback WHERE subject_id IN (
            SELECT Subject_ID FROM subject_table WHERE Subject_Name = '$subjectName'
        )";
                                $cloResult = mysqli_query($connection, $cloQuery);

                                while ($cloRow = mysqli_fetch_assoc($cloResult)) {
                                    $cloID = $cloRow['clo_id'];

                                    // Query to count the number of students with status 'Accepted' for the specific CLO
                              ...
                              AND status = 'Accepted'";
                                    ...
                                    // Query to count the number of students with status 'Remaining' for the specific CLO
                              ...
                              AND status = 'Remaining'";
                                    ...
                                    // Query to count the total number of students who gave feedback for the specific CLO
