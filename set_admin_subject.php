        ...
        <div class="row section-card">
            <div class="col-sm-5">
                <div class="card shadow-lg CLO-style-card" style=" width: 16.6rem; ">
                    ...
                    <a href="report_web.php" class="btn btn-add-clo clearfix shadow">Click to See Result</a>
                </div>
            </div>
            <div class="col-sm-5">
                <div class="card shadow-lg CLO-style-card" style=" width: 16.6rem; ">
                    ...
                    <a href="report_visual.php" class="btn btn-add-clo clearfix shadow">Click to See Result</a>
                </div>
            </div>
