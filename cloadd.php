...
<body>
    ...
    <div class="container ">
        <div class="row section-card">
            <div class="col-sm-4">
                <div class="card shadow-lg CLO-style-card" style=" width: 16.6rem; ">
                    ...
                    <a href="web_clo.php" class="btn btn-add-clo clearfix">Click to See CLO</a>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card shadow-lg CLO-style-card" style=" width: 16.6rem; ">
                    ...
                    <a href="visual_clo.php" class="btn btn-add-clo clearfix">Click to See CLO</a>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="card shadow-lg CLO-style-card " style=" width: 16.6rem; ">
                    <div class="card-body card-align ">
                        <h5 class="card-title ">Human Computer Interaction</h5>
                        <p class="card-text d-inline-block add-clo">H101</p>
                        <span class="float-right">
                            <i class="fa-solid fa-book-open fa-fade group"></i></span>
                    </div>
                    <a href="#" class="btn btn-add-clo clearfix">Click to See CLO</a>
                </div>
            </div>
        </div>
    </div>
